...
define($wp_ex.'PLUGIN_WP_URL_INSTALL', 'http://wordpress.org/plugins/wp-remove-css-js/installation/');
define($wp_ex.'PLUGIN_WP_URL_FAQ', 'http://wordpress.org/plugins/wp-remove-css-js/faq/');
...
define($wp_ex.'GITHUB_URL', 'https://github.com/GiuB/WP-Remove-Css-Js');
